...
def _load_module(mock_anthropic, mock_openai):
    """Force a fresh import of models.analyze_llm with mocked dependencies."""
    # Remove cached module so import triggers fresh execution
    ...
    with patch.dict(
        ...
        return importlib.import_module("langraph.models.analyze_llm")


class TestAnalyzeLlmAnthropic:
    @patch.dict(
        "os.environ",
    ...
    def test_default_provider_creates_anthropic(self):
        ...
        assert mod.analyze_llm == mock_anthropic.ChatAnthropic.return_value
...
class TestAnalyzeLlmOpenRouter:
    @patch.dict(
        "os.environ",
    ...
    def test_openrouter_provider_creates_openai(self):
        ...
        assert mod.analyze_llm == mock_openai.ChatOpenAI.return_value
