...
def _load_module(mock_anthropic, mock_openai):
    """Force a fresh import of models.structure_llm with mocked dependencies."""
    ...
    with patch.dict(
        ...
        return importlib.import_module("langraph.models.structure_llm")


class TestStructureLlmAnthropic:
    @patch.dict(
        "os.environ",
    ...
    def test_default_provider_creates_anthropic(self):
        ...
        assert mod.structure_llm == mock_anthropic.ChatAnthropic.return_value
...
class TestStructureLlmOpenRouter:
    @patch.dict(
        "os.environ",
    ...
    def test_openrouter_provider_creates_openai(self):
        ...
        assert mod.structure_llm == mock_openai.ChatOpenAI.return_value
