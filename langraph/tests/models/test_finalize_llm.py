...
def _load_module(mock_anthropic, mock_openai):
    """Force a fresh import of models.finalize_llm with mocked dependencies."""
    sys.modules.pop("langraph.models.finalize_llm", None)
    with patch.dict(
        sys.modules,
        {
        ...
        return importlib.import_module("langraph.models.finalize_llm")


class TestFinalizeLlmAnthropic:
    @patch.dict(
        "os.environ",
    ...
    def test_default_provider_creates_anthropic(self):
        ...
        assert mod.finalize_llm == mock_anthropic.ChatAnthropic.return_value
...
class TestFinalizeLlmOpenRouter:
    @patch.dict(
        "os.environ",
    ...
    def test_openrouter_provider_creates_openai(self):
        ...
        assert mod.finalize_llm == mock_openai.ChatOpenAI.return_value
